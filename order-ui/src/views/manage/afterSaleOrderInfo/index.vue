...
<!--      </el-form-item>-->
      ...
      <el-form-item label="售后金额" prop="afterSalePrice">
        <el-input
          v-model="queryParams.afterSalePrice"
          placeholder="请输入售后金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="afterSaleOrderInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="售后凭证" align="center" v-if="columns[6].visible" prop="afterSaleImage" width="100">
        <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 5, label: '售后日期', visible: true },
        { key: 6, label: '售后凭证', visible: true },
        { key: 7, label: '客服', visible: true },
