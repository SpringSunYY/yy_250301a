    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父级" prop="parentId">
          <treeselect v-model="form.parentId" :options="purchaseChannelInfoOptions" :normalizer="normalizer" placeholder="请选择父级" />
        </el-form-item>
        <el-form-item label="名称" prop="channelName">
...
<script>
import { listPurchaseChannelInfo, getPurchaseChannelInfo, delPurchaseChannelInfo, addPurchaseChannelInfo, updatePurchaseChannelInfo } from "@/api/manage/purchaseChannelInfo";
