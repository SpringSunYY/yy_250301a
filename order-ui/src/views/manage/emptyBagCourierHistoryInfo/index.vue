  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="emptyBagCourierHistoryInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="摘要" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="digest" />
        <el-table-column label="金额" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="price" />
        ...
        <el-table-column label="部门" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="deptId" />
...
<script>
import { listEmptyBagCourierHistoryInfo, getEmptyBagCourierHistoryInfo, delEmptyBagCourierHistoryInfo, addEmptyBagCourierHistoryInfo, updateEmptyBagCourierHistoryInfo } from "@/api/manage/emptyBagCourierHistoryInfo";
